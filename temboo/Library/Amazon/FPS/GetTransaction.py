...
class GetTransaction(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetTransaction, self).__init__(temboo_session, '/Library/Amazon/FPS/GetTransaction')
...
class GetTransactionInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(GetTransactionInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(GetTransactionInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_Endpoint(self, value):
        ...
        """
        super(GetTransactionInputSet, self)._set_input('Endpoint', value)
    def set_SubscriptionId(self, value):
        ...
        """
        super(GetTransactionInputSet, self)._set_input('SubscriptionId', value)
