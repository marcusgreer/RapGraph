...
class RetrieveReport(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RetrieveReport, self).__init__(temboo_session, '/Library/Amazon/Marketplace/Reports/RetrieveReport')
...
class RetrieveReportInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(RetrieveReportInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSMarketplaceId(self, value):
        """
        Set the value of the AWSMarketplaceId input for this Choreo. ((required, string) The Marketplace ID provided by Amazon Web Services.)
        """
        super(RetrieveReportInputSet, self)._set_input('AWSMarketplaceId', value)
    def set_AWSMerchantId(self, value):
        """
        Set the value of the AWSMerchantId input for this Choreo. ((required, string) The Merchant ID provided by Amazon Web Services.)
        """
        super(RetrieveReportInputSet, self)._set_input('AWSMerchantId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(RetrieveReportInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_EndDate(self, value):
        ...
        """
        super(RetrieveReportInputSet, self)._set_input('EndDate', value)
    def set_Endpoint(self, value):
        """
        Set the value of the Endpoint input for this Choreo. ((conditional, string) The base URL for the MWS endpoint. Defaults to mws.amazonservices.co.uk.)
        """
        super(RetrieveReportInputSet, self)._set_input('Endpoint', value)
    def set_ReportType(self, value):
        ...
        """
        super(RetrieveReportInputSet, self)._set_input('ReportType', value)
    def set_StartDate(self, value):
        ...
        """
        super(RetrieveReportInputSet, self)._set_input('StartDate', value)
    def set_TimeToWait(self, value):
        ...
        """
        super(RetrieveReportInputSet, self)._set_input('TimeToWait', value)
