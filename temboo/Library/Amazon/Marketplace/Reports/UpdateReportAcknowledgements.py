...
class UpdateReportAcknowledgements(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UpdateReportAcknowledgements, self).__init__(temboo_session, '/Library/Amazon/Marketplace/Reports/UpdateReportAcknowledgements')
...
class UpdateReportAcknowledgementsInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(UpdateReportAcknowledgementsInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSMarketplaceId(self, value):
        """
        Set the value of the AWSMarketplaceId input for this Choreo. ((required, string) The Marketplace ID provided by Amazon Web Services.)
        """
        super(UpdateReportAcknowledgementsInputSet, self)._set_input('AWSMarketplaceId', value)
    def set_AWSMerchantId(self, value):
        """
        Set the value of the AWSMerchantId input for this Choreo. ((required, string) The Merchant ID provided by Amazon Web Services.)
        """
        super(UpdateReportAcknowledgementsInputSet, self)._set_input('AWSMerchantId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(UpdateReportAcknowledgementsInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_Acknowledged(self, value):
        ...
        """
        super(UpdateReportAcknowledgementsInputSet, self)._set_input('Acknowledged', value)
    def set_Endpoint(self, value):
        """
        Set the value of the Endpoint input for this Choreo. ((conditional, string) The base URL for the MWS endpoint. Defaults to mws.amazonservices.co.uk.)
        """
        super(UpdateReportAcknowledgementsInputSet, self)._set_input('Endpoint', value)
    def set_ReportId(self, value):
        ...
        """
        super(UpdateReportAcknowledgementsInputSet, self)._set_input('ReportId', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are "xml" (the default) and "json".)
        """
        super(UpdateReportAcknowledgementsInputSet, self)._set_input('ResponseFormat', value)
