...
class AddOrUpdateInventoryItem(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddOrUpdateInventoryItem, self).__init__(temboo_session, '/Library/Amazon/Marketplace/Feeds/AddOrUpdateInventoryItem')
...
class AddOrUpdateInventoryItemInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSMarketplaceId(self, value):
        """
        Set the value of the AWSMarketplaceId input for this Choreo. ((required, string) The Marketplace ID provided by Amazon Web Services.)
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('AWSMarketplaceId', value)
    def set_AWSMerchantId(self, value):
        """
        Set the value of the AWSMerchantId input for this Choreo. ((required, string) The Merchant ID provided by Amazon Web Services.)
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('AWSMerchantId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_Description(self, value):
        """
        Set the value of the Description input for this Choreo. ((optional, string) )
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('Description', value)
    def set_Endpoint(self, value):
        """
        Set the value of the Endpoint input for this Choreo. ((conditional, string) The base URL for the MWS endpoint. Defaults to mws.amazonservices.co.uk.)
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('Endpoint', value)
    def set_ExpeditedShipping(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('ExpeditedShipping', value)
    def set_FulfillmentCenterId(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('FulfillmentCenterId', value)
    def set_ItemCondition(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('ItemCondition', value)
    def set_ItemNote(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('ItemNote', value)
    def set_Price(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('Price', value)
    def set_ProductIdType(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('ProductIdType', value)
    def set_ProductId(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('ProductId', value)
    def set_Quantity(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('Quantity', value)
    def set_SKU(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('SKU', value)
    def set_TimeToWait(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('TimeToWait', value)
    def set_Title(self, value):
        """
        Set the value of the Title input for this Choreo. ((optional, any) )
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('Title', value)
    def set_WillShipInternationally(self, value):
        ...
        """
        super(AddOrUpdateInventoryItemInputSet, self)._set_input('WillShipInternationally', value)
