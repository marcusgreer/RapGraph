...
class PlaceCheckInRequests(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(PlaceCheckInRequests, self).__init__(temboo_session, '/Library/Google/Places/PlaceCheckInRequests')
...
class PlaceCheckInRequestsInputSet(InputSet):
    ...
    def set_Key(self, value):
        ...
        """
        super(PlaceCheckInRequestsInputSet, self)._set_input('Key', value)
    def set_PlaceReference(self, value):
        ...
        """
        super(PlaceCheckInRequestsInputSet, self)._set_input('PlaceReference', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(PlaceCheckInRequestsInputSet, self)._set_input('ResponseFormat', value)
    def set_Sensor(self, value):
        ...
        """
        super(PlaceCheckInRequestsInputSet, self)._set_input('Sensor', value)
