...
class GetBloodPressureResultSet(ResultSet):
    ...
    def get_AverageDiastolic(self):
        ...
        """
        return self._output.get('AverageDiastolic', None)
    def get_AverageSystolic(self):
        """
