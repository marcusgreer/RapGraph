...
class PublishNote(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(PublishNote, self).__init__(temboo_session, '/Library/Facebook/Publishing/PublishNote')
...
class PublishNoteInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(PublishNoteInputSet, self)._set_input('AccessToken', value)
    def set_Message(self, value):
        """
        Set the value of the Message input for this Choreo. ((required, string) The contents of the note.)
        """
        super(PublishNoteInputSet, self)._set_input('Message', value)
    def set_ProfileID(self, value):
        ...
        """
        super(PublishNoteInputSet, self)._set_input('ProfileID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(PublishNoteInputSet, self)._set_input('ResponseFormat', value)
    def set_Subject(self, value):
        """
        Set the value of the Subject input for this Choreo. ((required, string) A subject line for the note being created.)
        """
        super(PublishNoteInputSet, self)._set_input('Subject', value)
