...
class MultiQuery(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(MultiQuery, self).__init__(temboo_session, '/Library/Facebook/Searching/MultiQuery')
...
class MultiQueryInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(MultiQueryInputSet, self)._set_input('AccessToken', value)
    def set_Queries(self, value):
        ...
        """
        super(MultiQueryInputSet, self)._set_input('Queries', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(MultiQueryInputSet, self)._set_input('ResponseFormat', value)
