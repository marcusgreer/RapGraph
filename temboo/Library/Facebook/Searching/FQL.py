...
class FQL(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(FQL, self).__init__(temboo_session, '/Library/Facebook/Searching/FQL')
...
class FQLInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(FQLInputSet, self)._set_input('AccessToken', value)
    def set_Conditions(self, value):
        ...
        """
        super(FQLInputSet, self)._set_input('Conditions', value)
    def set_Fields(self, value):
        """
        Set the value of the Fields input for this Choreo. ((required, string) The fields to return in the response.)
        """
        super(FQLInputSet, self)._set_input('Fields', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(FQLInputSet, self)._set_input('ResponseFormat', value)
    def set_Table(self, value):
        ...
        """
        super(FQLInputSet, self)._set_input('Table', value)
