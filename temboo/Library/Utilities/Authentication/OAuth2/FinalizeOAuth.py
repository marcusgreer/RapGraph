...
class FinalizeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(FinalizeOAuth, self).__init__(temboo_session, '/Library/Utilities/Authentication/OAuth2/FinalizeOAuth')
...
class FinalizeOAuthInputSet(InputSet):
    ...
    def set_AccessTokenEndpoint(self, value):
        ...
        """
        super(FinalizeOAuthInputSet, self)._set_input('AccessTokenEndpoint', value)
