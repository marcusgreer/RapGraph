...
class ImageInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ImageInputSet, self)._set_input('APIKey', value)
    def set_FallbackID(self, value):
        ...
        """
        super(ImageInputSet, self)._set_input('FallbackID', value)
    def set_ID(self, value):
        ...
        """
        super(ImageInputSet, self)._set_input('ID', value)
    def set_MaximumHeight(self, value):
        ...
        """
        super(ImageInputSet, self)._set_input('MaximumHeight', value)
    def set_MaximumWidth(self, value):
        ...
        """
        super(ImageInputSet, self)._set_input('MaximumWidth', value)
    def set_Mode(self, value):
        ...
        """
        super(ImageInputSet, self)._set_input('Mode', value)
