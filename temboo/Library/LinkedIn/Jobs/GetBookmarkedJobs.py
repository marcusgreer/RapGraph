...
class GetBookmarkedJobs(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetBookmarkedJobs, self).__init__(temboo_session, '/Library/LinkedIn/Jobs/GetBookmarkedJobs')
...
class GetBookmarkedJobsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetBookmarkedJobsInputSet, self)._set_input('APIKey', value)
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(GetBookmarkedJobsInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        ...
        """
        super(GetBookmarkedJobsInputSet, self)._set_input('AccessToken', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml (the default) and json.)
        """
        super(GetBookmarkedJobsInputSet, self)._set_input('ResponseFormat', value)
    def set_SecretKey(self, value):
        ...
        """
        super(GetBookmarkedJobsInputSet, self)._set_input('SecretKey', value)
