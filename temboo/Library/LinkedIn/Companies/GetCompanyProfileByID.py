...
class GetCompanyProfileByID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetCompanyProfileByID, self).__init__(temboo_session, '/Library/LinkedIn/Companies/GetCompanyProfileByID')
...
class GetCompanyProfileByIDInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetCompanyProfileByIDInputSet, self)._set_input('APIKey', value)
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(GetCompanyProfileByIDInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        ...
        """
        super(GetCompanyProfileByIDInputSet, self)._set_input('AccessToken', value)
    def set_CompanyID(self, value):
        ...
        """
        super(GetCompanyProfileByIDInputSet, self)._set_input('CompanyID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml (the default) and json.)
        """
        super(GetCompanyProfileByIDInputSet, self)._set_input('ResponseFormat', value)
    def set_SecretKey(self, value):
        ...
        """
        super(GetCompanyProfileByIDInputSet, self)._set_input('SecretKey', value)
