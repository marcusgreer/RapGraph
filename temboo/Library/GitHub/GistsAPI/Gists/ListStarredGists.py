...
class ListStarredGists(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListStarredGists, self).__init__(temboo_session, '/Library/GitHub/GistsAPI/Gists/ListStarredGists')
...
class ListStarredGistsInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(ListStarredGistsInputSet, self)._set_input('AccessToken', value)
    def set_Page(self, value):
        ...
        """
        super(ListStarredGistsInputSet, self)._set_input('Page', value)
