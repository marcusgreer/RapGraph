...
class ListPublicGists(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListPublicGists, self).__init__(temboo_session, '/Library/GitHub/GistsAPI/Gists/ListPublicGists')
...
class ListPublicGistsInputSet(InputSet):
    ...
    def set_Page(self, value):
        ...
        """
        super(ListPublicGistsInputSet, self)._set_input('Page', value)
